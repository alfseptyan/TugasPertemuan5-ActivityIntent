package com.example.tugaspertemuan5_activityintent

import android.content.Intent
import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import com.example.tugaspertemuan5_activityintent.databinding.ActivityMain2Binding
import com.example.tugaspertemuan5_activityintent.databinding.ActivityMainBinding
...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogin.setOnClickListener {
            ...
            binding.username.setText(registeredUsername)
            binding.password.setText(registeredPassword)
        }
    }
}
